...
clear
echo  $green
echo 'Sabar orang sabar disayang janda.........................';
sleep 0.1;
clear
echo  $green
echo 'Loading.................';
...
echo
echo
toilet -f future "    Deface AL FF ID" | lolcat
echo
echo $red"##########################$green" Deface By ALLZ FF ID "$red###########################"
echo $yellow
figlet -f future "Squad DarkCyber Team"
echo
echo $red"##########################$green" YT:ALLZ FF ID "$red###########################"
echo
